...
local cvp=nil; local function getVP() if cvp==nil then local o=getSandboxOptions():getOptionByName('WDecay.vinePercentage'); cvp=o and o:getValue() or 40 end; return cvp end
...
local function createVine(square,obj,isLow,objs)
    ...
    if WDecay_Protection.isPlayerBuilt(obj) and not WDecay_Scaling.isRedecayPass() then return end
